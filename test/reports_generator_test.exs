defmodule ReportsGeneratorTest do
  ...
  describe "fetch_higher_cost/1" do
    test "when the otpion is 'users', returns the user who spent the most" do
      filename = "report_test.csv"
    ...
    test "when the otpion is 'foods', returns the most consumed foods" do
      filename = "report_test.csv"
    ...
    test "when invalid option is given, return error" do
      filename = "report_test.csv"
